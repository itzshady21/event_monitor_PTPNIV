...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-success">
    <a class="navbar-brand ps-3 text-white d-flex align-items-center gap-2" href="{{ route('dashboard') }}">
            ...
            <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="{{ route('formEvent') }}">
                            <div class="sb-nav-link-icon"><i class="fa-solid fa-id-card"></i></div>
                            Input Peserta
                        </a>
                        <a class="nav-link" href="{{ route('formLihatData') }}">
                            <div class="sb-nav-link-icon"><i class="fa-solid fa-book-open"></i></div>
                            Daftar Peserta
                        </a>
                        <a class="nav-link" href="{{ route('formSertifikat') }}">
                            <div class="sb-nav-link-icon"><i class="fa-solid fa-file-upload"></i></div>
                            Upload Sertifikat Pelatihan
                        </a>
                        <a class="nav-link" href="{{ route('createKaryawan') }}">
                            <div class="sb-nav-link-icon"><i class="fa-solid fa-user-plus"></i></div>
                            Input Karyawan
                        </a>
                        <a class="nav-link" href="{{ route('listKaryawan') }}">
                        ...
                        <a class="nav-link" href="{{ route('formPelatihan') }}">
